...
public:
	QJsonChannelBeastImpl(size_t threadCount) : ioc(threadCount), _threadCount(threadCount) {
	}
...
QJsonChannelBeast::QJsonChannelBeast(size_t threadCount) : _impl (new QJsonChannelBeastImpl(threadCount)) {
}

QJsonChannelBeast::~QJsonChannelBeast() {
	delete _impl;
}

void QJsonChannelBeast::start(const tcp::endpoint& ep) {
